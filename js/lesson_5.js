...
/////////////////////////////////
document.write('<hr/>');
// Оператор with - создает новую область видимости и представляет свойства объекта "object" как локальные переменные (with - старье). Strict Mode запрещает его использование
